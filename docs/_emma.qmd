...
-   Use `DataExplorer` to generate a comprehensive report
    -   Includes summary statistics, distributions, missing data, correlations, PCA, qq plots, and more
...
::: notes
[Can reuse and rerun script for other years simply by replacing sheet name in "Import Data" step]{.smaller} [OR wrap script into function]{.smaller} [Make sure to add proper documentation!]{.smaller}
:::
