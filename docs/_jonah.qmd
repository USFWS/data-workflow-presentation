...
![](images/r_project_icon.png){.shadow width="15%" fig-align="center" fig-alt="Image of Rstudio project icon."}

:::

::: notes
To start, we recommend creating an RStudio project. An R project serves as a project folder, or root directory, that houses all your project-related files and folders in one place. By establishing an R project, you create a default working directory, or root directory for your project, which helps minimize file path issues when sharing the project with others. 
:::
...
![](images/rdr_file_structure.png){.shadow width="75%" fig-align="right" fig-alt="Image of Alaska Regional Data Repository File Structure"}
...
{{< fa "arrow-right" size=3x title="arrow icon" >}} 
...
![](images/r_project_icon.png){.shadow width="35%" fig-align="left" fig-alt="Image of Rstudio project icon."} 
...
::: notes
R projects also facilitate the bundling of all our project files, creating a self-contained package of our project, much like a map package in ArcGIS, which allows us to easily share our project with others. Lastly, R projects make is possible for us to implement version control, which we will discuss shortly.
:::
...
:::notes
There are a number of folder structure templates you can use but we would direct you to the Alaska Regional Data Repository template, the refuges template, and the Roxygen2 template. The Alaska regional data repository and alaska refuges templates are great for project files structures and the roxygen2 file template is particularly useful when creating packages and documenting code.
:::
...
:::notes
In a manual workflow we could manually copy and paste our documents to network drives or external hard drives or use software like Microsoft Teams or OneDrive to back our files us regularly and retain older versions.
:::
